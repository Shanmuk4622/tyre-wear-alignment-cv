...
\raggedbottom
\pagestyle{headings}
\history{Author-review manuscript, September 19, 2026.}
\doi{Not assigned}
...
\uppercase{Shanmukesh Bonala}\authorrefmark{2}}
\address[1]{(sreenivasareddy.e@vitap.ac.in) School of Computer Science and Engineering, VIT-AP University, Amaravati, India}
\address[2]{(shanmukesh.23BCE20070@vitapstudent.ac.in) School of Computer Science and Engineering, VIT-AP University, Amaravati, India}
\corresp{Corresponding author (proposed): Sreenivasa Reddy Edara (e-mail: sreenivasareddy.e@vitap.ac.in).}
